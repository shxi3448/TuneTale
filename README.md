...
## *Dataset*
The dataset we plan to use has 114,000 tracks from 114 different genres from Spotify's API. Here is the link: [Spotify Tracks Dataset | Audio Features](https://www.kaggle.com/datasets/saichaitanyareddyai/spotify-tracks-dataset-audio-features)
...
3. **The dataset path will be printed:**
   ...
   **Note:** The `.env` file is gitignored for security, so don't commit your API token!
